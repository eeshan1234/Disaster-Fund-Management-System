...
public class payment extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    Spinner spinner;
    String[] category={"Food","Shelter","Livelihood"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                lbname=name;
                String upiId = "amitak22jan@okhdfcbank";
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(payment.this)) {
            ...
            if (status.equals("success")) {
                ...
                databaseReference=FirebaseDatabase.getInstance().getReference("Users").child("8777022293").child("payments");
                long a=System.currentTimeMillis();
                //String a=amountEt.toString();
                databaseReference.child(""+a).child("Amounts").setValue(lb);
                databaseReference.child(""+a).child("Name").setValue(lbname);

                databaseReference.child(""+a).child("Flag1").setValue("1");
                databaseReference.child(""+a).child("Flag2").setValue("0");

                Intent intent=new Intent(payment.this,acknowledgement.class);
                ...
                //databaseReference.child("payments").child("Name").setValue(nameEt);
            }
            else {
